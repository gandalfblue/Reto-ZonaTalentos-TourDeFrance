...
@Service
@Validated
public class CreateCyclingTeamUseCase implements SaveTeam {

    private final CyclingTeamRepository cyclingTeamRepository;
    private final CyclingTeamMapper cyclingTeamMapper;

    public CreateCyclingTeamUseCase(CyclingTeamRepository cyclingTeamRepository, CyclingTeamMapper cyclingTeamMapper) {
